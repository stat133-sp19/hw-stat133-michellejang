...
In Cartesian Coordinates, if $\mathbf{p} = (p_{1}, p_{2},...p_{n})$ and $\mathbf{q} = (q_{1}, q_{2},...q_{n})$ are two points in Euclidean-space, then the distance (d) from **p** to **q** is given by the Pythagorean formula:
...
\[ ||\mathbf{p}||= \sqrt{p_{1}^2 +  p_{2}^2 +... p_{n}^2} = \sqrt{\mathbf{p\cdot p,}}\]
